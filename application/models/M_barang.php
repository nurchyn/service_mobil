...
{
	var $table = 'm_barang';
	var $column_search = ['m_barang.nama_barang','m_barang.stok','m_barang.harga_awal', 'm_barang.harga_jual', 'm_barang.id_kategori_barang'];
	...
	var $column_order = [
		...
		'm_barang.harga_jual',
		'm_barang.stok',
		'm_barang.id_kategori_barang',
		null
	];

	var $order = ['m_barang.id' => 'desc']; 
	...
	{
		$this->db->select('
			m_barang.*,m_kategori_barang.nama_kategori
		');
        $this->db->join('m_kategori_barang', 'm_kategori_barang.id=m_barang.id_kategori_barang', 'left');
