...
class M_customer extends CI_Model
{
	...
	var $column_search = ['m_customer.nama_customer','m_customer.alamat','m_customer.telp'];
	...
	private function _get_datatables_query($term='')
	{
		...
		$this->db->where('m_customer.deleted_at is null');
		$this->db->order_by('m_customer.id', 'DESC');
