...
class M_item_trans extends CI_Model
{
	var $table = 'm_item_trans';
	var $column_search = ['kode_jenis','nama_jenis','keterangan'];
	...
	var $order = ['m_item_trans.nama' => 'asc']; 
	...
	private function _get_datatables_query($term='')
	{
		...
		$this->db->from('m_item_trans');
        $this->db->join('m_jenis_trans', 'm_item_trans.id_jenis_trans=m_jenis_trans.id', 'left');
		$this->db->where('m_item_trans.deleted_at is null');
