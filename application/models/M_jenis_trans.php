...
class M_jenis_trans extends CI_Model
{
	var $table = 'm_jenis_trans';
	...
	var $order = ['m_jenis_trans.nama_jenis_trans' => 'asc']; 
	...
	private function _get_datatables_query($term='')
	{
		...
		$this->db->from('m_jenis_trans');
		$this->db->where('m_jenis_trans.deleted_at is null');
