...
class M_master_kendaraan extends CI_Model
{
	var $table = 'm_kendaraan';
	var $column_search = ['m_kendaraan.nama_kendaraan','m_kendaraan.warna','m_kendaraan.nopol'];
	...
	private function _get_datatables_query($term='')
	{
		...
		$this->db->from('m_kendaraan');	
		$this->db->join('m_merek', 'm_merek.id=m_kendaraan.merek', 'left');
		$this->db->where('m_kendaraan.deleted_at is null');
		$this->db->order_by('m_kendaraan.id', 'DESC');
