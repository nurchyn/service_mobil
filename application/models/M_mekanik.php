...
{
	var $table = 'm_mekanik';
	var $column_search = ['m_mekanik.nama_mekanik','m_mekanik.alamat','m_mekanik.email', 'm_mekanik.no_telp', 'm_mekanik.jenis_kelamin'];
	...
	var $column_order = [
		...
		'm_mekanik.email',
		'm_mekanik.no_telp',
		'm_mekanik.jenis_kelamin',
		null
	];

	var $order = ['m_mekanik.id' => 'desc']; 
	...
	private function _get_datatables_query($term='')
	{
		...
		$this->db->where('m_mekanik.deleted_at is null');
