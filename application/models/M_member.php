...
{
	var $table = 'm_member';
	var $column_search = ['m_member.kode_member','m_member.nama','m_member.alamat'];
	...
	var $column_order = [
        ...
        'm_user.counter_diskon',
		null
	];

	var $order = ['m_member.id' => 'desc']; 
	...
	private function _get_datatables_query($term='')
	{
		...
		$this->db->where('m_member.deleted_at is null');
