...
{
	var $table = 'm_pekerjaan';
	var $column_search = ['m_pekerjaan.type_wo','m_pekerjaan.nama_pekerjaan'];
	
	var $column_order = [
		null, 
		'm_pekerjaan.type_wo',
		'm_pekerjaan.nama_pekerjaan',
		null
	];

	var $order = ['m_pekerjaan.id' => 'desc']; 
	...
	private function _get_datatables_query($term='')
	{
		...
		$this->db->where('m_pekerjaan.deleted_at is null');
		$this->db->order_by('m_pekerjaan.id', 'DESC');
