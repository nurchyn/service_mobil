...
class M_supplier extends CI_Model
{
	...
	var $column_search = ['m_supplier.nama_supplier','m_supplier.alamat_supplier','m_supplier.telp_supplier'];
	
	var $column_order = [
		null, 
		'm_supplier.nama_supplier',
		'm_supplier.alamat_supplier',
		'm_supplier.telp_supplier',
		null
	];

	var $order = ['m_supplier.id' => 'desc']; 
	...
	private function _get_datatables_query($term='')
	{
		...
		$this->db->where('m_supplier.deleted_at is null');
