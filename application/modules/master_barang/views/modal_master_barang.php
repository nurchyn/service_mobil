        ...
        <form id="form-user" name="form-user">
          ...
          <div class="row">
            <div class="form-group col-sm-5">
              <label for="lbl_username" class="form-control-label">Harga Awal:</label>
              <input type="number" class="form-control" id="harga_awal" name="harga_awal" autocomplete="off">
              <span class="help-block"></span>
            </div>
            <div class="form-group col-sm-5">
              <label for="lbl_username" class="form-control-label">Harga Awal:</label>
            ...
            <div class="form-group col-sm-2">
              <label for="lbl_username" class="form-control-label">Stok:</label>
