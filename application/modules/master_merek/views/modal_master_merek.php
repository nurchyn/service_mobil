      ...
      <div class="modal-body">
        <form id="form-user" name="form-user">
          <div class="form-group">
            ...
            <label for="lbl_username" class="form-control-label">Nama Merek Mobil:</label>
            <input type="text" class="form-control" id="nama" name="nama" autocomplete="off">
            <span class="help-block"></span>
          </div>
          <div class="form-group">
            <label for="lbl_username" class="form-control-label">Chasis:</label>
            <input type="text" class="form-control" id="produsen" name="produsen" autocomplete="off">
            <span class="help-block"></span>
          </div>
