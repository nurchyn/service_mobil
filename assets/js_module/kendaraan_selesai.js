...
function edit_kendaraan(id)
{
    ...
    $.ajax({
        url : base_url + 'master_merek/edit_merek',
        type: "POST",
        dataType: "JSON",
        data : {id:id},
        success: function(data)
        {
            ...
            // $('[name="nama"]').val(data.old_data.nama_merek);
            // $('[name="produsen"]').val(data.old_data.produsen);
            $('#modal_user_form').modal('show');
...
function save()
{
    ...
    if(save_method == 'add') {
        ...
        url = base_url + 'master_merek/update_data_merek';
        txtAksi = 'Edit Merek Mobil';
    }
