...
function add_menu()
{
	...
	$('#modal_title').text('Tambah Barang'); 
}
...
function save()
{
    ...
    if(save_method == 'add') {
        ...
        txtAksi = 'Tambah Data Barang';
    }else{
        url = base_url + 'master_barang/update_data_barang';
        txtAksi = 'Edit Data Barang';
    }
