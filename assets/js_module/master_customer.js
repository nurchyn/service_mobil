...
$(document).ready(function() {
	...
	//datatables
	table = $('#tabel_customer').DataTable({
		responsive: true,
        searchDelay: 500,
        processing: true,
        serverSide: true,
		ajax: {
			url  : base_url + "master_customer/list_customer",
			type : "POST" 
		},
...
function edit_customer(id)
{
    ...
    $.ajax({
        url : base_url + 'master_customer/edit_customer',
        type: "POST",
        dataType: "JSON",
        data : {id:id},
        success: function(data)
        {
            ...
            $('[name="nama"]').val(data.old_data.nama_customer);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = base_url + 'master_customer/add_data_customer';
        txtAksi = 'Tambah Data Customer';
    }else{
        url = base_url + 'master_customer/update_data_customer';
        txtAksi = 'Edit Data Customer';
    }
...
function delete_customer(id){
    swalConfirmDelete.fire({
        ...
        if (result.value) {
            $.ajax({
                url : base_url + 'master_customer/delete_customer',
                type: "POST",
                dataType: "JSON",
                data : {id:id},
                success: function(data)
